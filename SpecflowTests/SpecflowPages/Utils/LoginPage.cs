  ...
  public class LoginPage
    {
        public static void LoginStep()
        {
            ...
            //Enter Username
            Driver.driver.FindElement(By.XPath("//input[@name='email']")).SendKeys("pittone@mailinator.com");

            //Enter password
            Driver.driver.FindElement(By.XPath("//input[@name='password']")).SendKeys("luck0629");
            Thread.Sleep(1000);
